...
test.describe('PUT /booking/{id} - content-type', () => {
  test('should return 400 when Content-Type is text/plain', async ({ apiClient }) => {
    ...
    const response = await bookingApi.update(created.bookingid, BookingPayloadBuilder.valid(), {
      Cookie: authCookie,
